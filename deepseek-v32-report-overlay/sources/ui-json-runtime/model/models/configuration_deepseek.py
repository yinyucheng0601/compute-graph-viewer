...
class DeepseekV3IndexConfig(DeepseekV3Config):
    ...
    Args:
        compress_block_size (`int`, defaults to 32):
            compress block size l of compressed attention
        sliding_stride (`int`, defaults to 16):
            sliding stride of compressed attention
        select_block_size (`int`, defaults to 64):
            select block size of selected attention
        select_block_count (`int`, defaults to 16):
            select block count(topK) of selected attention
