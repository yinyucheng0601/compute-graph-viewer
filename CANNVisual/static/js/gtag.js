...
(function() {
  ...
  Vd.Ue = Number('') || 0;
  Vd.fa = 'dataLayer';
  Vd.Oh = 'ChEI8MC+mgYQs++Pz63hlqGFARInAACavj/YY36SFJh3br9m9AgySxyJXeCzp3iPjPCmt+E5IPyFbmpGGgIIAg\x3d\x3d';
  var Yd = {
      __cl: !0,
      __ecl: !0,
      __ehl: !0,
  ...
  var Pe = /:[0-9]+$/,
    ...
    Te = function(a, b, c, d, e) {
      ...
      'port' === b
        ...
        : 'host' === b && (a.hostname = (a.hostname || E.location.hostname).replace(Pe, '').toLowerCase());
      return Se(a, b, c, d, e);
    },
  ...
  function qg(a, b, c) {
    for (var d = [], e = pg(a, void 0, void 0, c), f = 0; f < e.length; f++) {
      ...
      if (!b || -1 !== b.indexOf(l)) {
        var m = g.shift();
        m && ((m = m.split('-')), d.push({id: g.join('.'), Zd: 1 * m[0] || 1, dd: 1 * m[1] || 1}));
      }
    }
    return d;
  }
  ...
  var Qg = {M: 'UA-121774282-4', Hb: ''},
    Rg = {rh: 'UA-121774282-4', sh: 'UA-121774282-4'};
  Qg.Se = Aa('');
  var Sg = function() {
  ...
  var $g = {'': 'n', UA: 'u', AW: 'a', DC: 'd', G: 'e', GF: 'f', GT: 't', HA: 'h', MC: 'm', GTM: 'g', OPT: 'o'},
    ...
    bh = function(a) {
      ...
      if (Fc(45)) {
        ...
        var l = d.xk,
          m =
            '4' + e + (l ? '' + ad(2, 1) + '0123456789abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ-_'[l] : ''),
          n,
          p = d.dk;
  ...
  var sh = function(a) {
    ...
    rh = function(a, b) {
      ...
      b = void 0 === b ? !1 : b;
      c.fetch
        ? c.fetch(a, {keepalive: !0, credentials: 'include', redirect: 'follow', method: 'get', mode: 'no-cors'})
        : qh(c, a, void 0 === b ? !1 : b);
    };
  var th = function() {};
  var uh = function(a) {
  ...
  var yh = function(a, b, c) {
      ...
      if (0 === l)
        ...
        m =
          1 === l
            ? a.purpose && a.vendor
              ? xh(a.purpose.legitimateInterests, b) && xh(a.vendor.legitimateInterests, void 0 === d ? '755' : d)
              : !0
            : !0;
      return m;
    },
  ...
  function Vh(a, b, c) {
    ...
    var e = d.split('.');
    5 === e.length
      ? ((Rh[a] = e.slice(0, 2).join('.')), (Sh[a] = {id: e.slice(2, 4).join('.'), nh: Number(e[4]) || 0}))
      : 3 === e.length
        ...
        for (var e = {countryNameCode: c, destinationNumber: b, retrievalTime: Da()}, f = 0; f < a.length; f++) {
          ...
          Ij[g.id] ||
            (g && 'AW' === g.prefix && !e.adData && 2 <= g.I.length
              ...
              : g && 'UA' === g.prefix && !e.gaData && ((e.gaData = {gaWpid: g.U}), (Ij[g.id] = !0)));
        }
  ...
  var qk = nk,
    rk = 'https://www.googletagmanager.com/a?id=' + Qg.M + '&cv=1',
            ...
            r = Il(
              Gl(
                Fl(
                  El(
                    Cl(
                      Bl(Dl(Al(zl(yl(new xl(d.messageContext.eventId, d.messageContext.priorityId), g), l), m), n), p),
                      q
                    ),
  ...
  Hp.prototype.flush = function(a) {
    for (var b = this, c = [], d = !1, e = {}; this.h.length; ) {
      ...
      if (f.messageContext.deferrable)
        !f.W || Ip(this, f.W).m ? ((f.messageContext.deferrable = !1), this.h.push(f)) : c.push(f), this.h.shift();
      else {
        var g = void 0;
        switch (f.type) {
          case 'require':
  ...
  var Vp = {
      ...
      set: function(a, b) {
        ...
        2 == a.length && J(a[1])
          ? (c = N(a[1]))
          : 3 == a.length && h(a[1]) && ((c = {}), J(a[2]) || qa(a[2]) ? (c[a[1]] = N(a[2])) : (c[a[1]] = a[2]));
        if (c) {
          var d = Up(a, b),
            e = d.eventId,
            f = d.priorityId;
  ...
  function Eq() {
    ...
    if (xq || !Dq(c.message)) b = c;
      ...
      var e = {},
        ...
        g = {},
        l = {message: ((g.event = 'gtm.init'), (g['gtm.uniqueEventId'] = d - 1), g), messageContext: {eventId: d - 1}};
      vq.unshift(l, c);
      if (qk && Qg.M) {
        var m;
        if (Qg.Se) {
  ...
  var wt = window,
    ...
    yt = function(a) {
      ...
      for (var d = jg('AMP_TOKEN', String(xt.cookie), !0), e = 0; e < d.length; e++) if ('$OPT_OUT' == d[e]) return !0;
  ...
  var iv,
    ...
    dv = function(a, b) {
      ...
      else if ('select_content' === a || (mv && a === R.g.nc)) t = {action: 'click', Ra: {list: e() || g}, Bb: nv(f)};
      else if (a === R.g.Ib || 'checkout_progress' === a) {
        var r = {step: a === R.g.Ib ? 1 : d(R.g.Tf), option: d(R.g.Sf)};
        t = {action: 'checkout', Bb: nv(f), Ra: N(c(), r)};
      } else 'set_checkout_option' === a && (t = {action: 'checkout_option', Ra: {step: d(R.g.Tf), option: d(R.g.Sf)}});
      t && (t.af = d(R.g.ma));
      return t;
    },
    Kv = {},
      ...
      (function(a) {
        ...
        c
          ? (G(a.vtp_gtmOnSuccess),
            Cp.register(a.vtp_containerId, c),
            a.vtp_remoteConfig && Lp(a.vtp_containerId, a.vtp_remoteConfig || {}))
          : G(a.vtp_gtmOnFailure);
      });
    })();
  (Z.o.cid = ['google']),
  ...
  (Z.o.get = ['google']),
    (function() {
      (function(a) {
        ...
        var f = Eo(String(b.streamId), d, c);
        Ho(f, e.eventId, e);
        a.vtp_gtmOnSuccess();
      });
    })();
    ...
    if (ie) a();
      ...
      var f = function(r) {
          ...
          y ||
            ...
            vb('https://' + Vd.rd + '/debug/bootstrap?id=' + Qg.M + '&src=' + w + '&cond=' + r + '&gtm=' + bh()));
          var x = {
